...
def runOSPF(net):
    ...
    print("cached router paths: ", cached_router_paths)
...
def run():
    ...
    net['r1'].cmdPrint("./scripts_for_router1.sh")
    net['r2'].cmdPrint("./scripts_for_router2.sh")
    net['r3'].cmdPrint("./scripts_for_router3.sh")
    net['r4'].cmdPrint("./scripts_for_router4.sh")
